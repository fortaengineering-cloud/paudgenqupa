...
export default function FloatingWAButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-[9999] flex items-center gap-2 bg-[#25D366] text-white p-3 md:p-4 rounded-full shadow-2xl hover:scale-110 transition-all group"
